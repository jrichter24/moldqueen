...
(function () {
  ...
  var DE = {
    ...
    "ix.esp.p": "Ein dritter Funkkern auf einem winzigen, günstigen ESP32-S3-Board: ein sauber neu geschriebener C-Codec, derselbe Bluetooth-LE-Advertiser und dieselbe WebSocket-Schnittstelle über WLAN. Er hat bereits ein echtes Modell gefahren. Kein Pi, kein Handy, nur das Board im Netzwerk.",
    "ix.esp.muted": "Noch in Arbeit: die WLAN-Zugangsdaten über eine Einrichtungsseite und das Ausliefern der Oberfläche direkt vom Board. Build-Hinweise stehen im Ordner <a href=\"https://github.com/jrichter24/moldqueen/tree/main/esp32-core\" rel=\"noopener\">esp32-core</a>.",
    // ---- index: developers ----
    ...
    "ix.rm.esp": "<b>ESP32-Feinschliff.</b> <span>Der ESP32-Kern steuert schon heute Modelle über WLAN. Es fehlt noch der Komfort: die WLAN-Einrichtung direkt am Board (ohne fest hinterlegte Zugangsdaten) und das Ausliefern des Clients direkt aus dem Flash.</span>",
