...
(function () {
  ...
  var DE = {
    ...
    "ix.and.p": "Eine App, die alles selbst mitbringt. Sie nutzt den Bluetooth-Funk des Handys, liefert die Oberfläche direkt auf dem Gerät und kommt ohne Pi und ohne Netzwerk aus. Bisher ist es ein Entwickler-Build, den du über USB installierst:",
    "ix.and.muted": "Eine signierte, store-taugliche Version steht auf der <a href=\"#roadmap\">Roadmap</a>. Builds und Notizen gibt es bei <a href=\"https://github.com/jrichter24/moldqueen/releases\" rel=\"noopener\">GitHub Releases</a>.",
