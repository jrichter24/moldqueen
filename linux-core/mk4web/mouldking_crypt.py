...
under the MIT License (see ../../THIRD-PARTY-NOTICES.md). Re-expressed in this
module's structure and cross-checked against §4 of
MKtech_reverse_engineering_report.md. `decode` is the exact inverse, which unblocks Route A (capture the app's device-1 adverts and
